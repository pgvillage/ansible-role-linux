...
This role manages all linux tasks for a PgVillage PostgreSQL cluster.
...
Please see [defaults](https://github.com/pgvillage/ansible-role-linux/blob/main/defaults/main.yml) for all variables
